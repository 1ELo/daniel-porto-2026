...
export const professionalProjects: Project[] = [
    {
        ...
        stack: ['FastAPI', 'Redis', 'Celery', 'MinIO', 'Trino', 'OpenCLIP', 'k6', 'Azure Blob'],
    ...
    },
    {
        ...
        stack: ['AES-256-GCM', 'ECIES', 'JWT', 'ArangoDB', 'Node.js', 'LLM'],
        links: [{ label: 'Internal Project', url: '#' }]
    }
];

export const additionalContributions: AdditionalContribution[] = [
    { description: 'Implemented FHIR R4 resources (Patient, Observation, MedicationRequest) to standardize health data exchange, enabling interoperability with external healthcare providers.' },
...
export const personalProjects: Project[] = [
    {
        ...
        stack: ['DenoTS', 'SvelteKit', 'Supabase', 'Midtrans'],
